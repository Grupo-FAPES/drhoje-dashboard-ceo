@echo off
title Atualizando Dashboard CEO e Publicando no GitHub...

cd /d "c:\Users\marcelo.guedes\Grupo Fapes Projetos\Dr Hoje\dr-hoje-dashboard-ceo"

if not exist "data" mkdir "data"
set LOGFILE=data\execucao_atualizacao.log

echo ======================================================== >> %LOGFILE%
echo [%DATE% %TIME%] INICIANDO ATUALIZACAO LOCAL - CEO >> %LOGFILE%
echo ======================================================== >> %LOGFILE%
...
if %ERRORLEVEL% NEQ 0 (
    ...
    git commit -m "data: atualizar base de dados do dashboard ceo" >> %LOGFILE% 2>&1
    git push origin main >> %LOGFILE% 2>&1
    echo [%DATE% %TIME%] SUCESSO! Dashboard do CEO atualizado e publicado no GitHub! >> %LOGFILE%
    echo.
    echo ========================================================
    echo SUCESSO! Dashboard do CEO atualizado e publicado!
